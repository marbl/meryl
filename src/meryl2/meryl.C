...
bool processDebugOption (int &argc, char **argv, std::vector<char const *> &err);
bool processGlobalOption(int &argc, char **argv, std::vector<char const *> &err);
bool processLegacyOption(int &argc, char **argv, std::vector<char const *> &err);
...
main(int argc, char **argv) {
  ...
  for (int32 arg=1; arg < argc; arg++) {
    if ((processDebugOption (arg, argv, err) == true) ||
        (processGlobalOption(arg, argv, err) == true) ||
        (processLegacyOption(arg, argv, err) == true))
