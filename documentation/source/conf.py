...
project = u'meryl'
copyright = u'2018-2021, Brian Walenz, Arang Rhie'
...
latex_documents = [
  ('index', 'meryl.tex', u'meryl Documentation',
   u'Brian Walenz', 'Arang Rhie', 'manual'),
]
...
man_pages = [
    ('index', 'meryl', u'meryl Documentation',
     [u'Brian Walenz, Arang Rhie'], 1)
]
...
texinfo_documents = [
  ('index', 'canu', u'meryl Documentation',
   u'Brian Walenz, Arang Rhie', 'meryl', 'One line description of project.',
   'Miscellaneous'),
]
